...
public class MetricsExample extends SimpleClient {
   ...
   public void addMetrics() {
	   getSession().getCluster().getMetrics().getRegistry()
	   	.newGauge(
	   			getClass(),
	   			"com.pbertoni.cassandra.numberInserts", 
	   			new Gauge<Integer>() {
	   				@Override
   ...
   public void addMetrics02() {
   	...
   	.newGauge(
   			getClass(),
   			"com.pbertoni.cassandra.insertMetrics", 
	...
	public void printMetrics() {
      ...
      Metric ourMetric = getSession()
      		...
      		.getRegistry()
      		.allMetrics()
      		.get(new MetricName(getClass(), "com.pbertoni.cassandra.numberInserts"));
	...
	public void printMetrics02() {
      Metric ourMetric = getSession()
      		...
      		.getRegistry()
      		.allMetrics()
      		.get(new MetricName(getClass(), "com.pbertoni.cassandra.insertMetrics"));
