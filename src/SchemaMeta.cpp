...
void SchemaMeta::print_keyspace(CassSession* session, const char* keyspace)
{
...
void SchemaMeta::print_table(CassSession* session, const char* keyspace, const char* table)
{
	const CassSchema* schema = cass_session_get_schema(session);
	const CassSchemaMeta* keyspace_meta = cass_schema_get_keyspace(schema, keyspace);
...
void SchemaMeta::print_error(CassFuture* future)
{
	const char* message;
...
CassError SchemaMeta::execute_query(CassSession* session, const char* query)
{
